...
//        System.out.println((centerY-sizey/2));
    ...
    public void mousePressed(long window, int button) {
        ct.send(Message.encode(Integer.toString(button), Message.MessageProtocol.SEND,Message.MessageType.KEY_PRESSED));
    }
    public void mouseReleased(long window, int button) {
        ct.send(Message.encode(Integer.toString(button), Message.MessageProtocol.SEND,Message.MessageType.KEY_RELEASED));
